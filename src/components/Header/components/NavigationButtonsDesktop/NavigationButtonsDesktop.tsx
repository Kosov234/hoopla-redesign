export const NavigationButtonsDesktop = () => {
  return (
    <nav className="hidden xl:flex gap-10 items-center text-hoopla-black">
      ...
      <button className="hover:text-hoopla-electric-blue">Partners</button>
      <button className="hover:text-hoopla-electric-blue">Landing Page</button>
      <button className="hover:text-hoopla-electric-blue">Contact Sales</button>
    </nav>
  );
};
